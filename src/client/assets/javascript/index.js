...
async function runRace(raceID) {
	try{
		...
		return console.log("Error in runRace function::", err);
	}
...
function getTracks() {
	...
	return fetch(`${SERVER}/api/tracks`)
		...
		.catch(err => console.log("Failed getTracks request::", err));
...
function getRacers() {
	...
	return fetch(`${SERVER}/api/cars`)
		...
		.catch(err => console.log("Failed getRacers request::", err));
}
...
async function getRace(id) {
	...
	try {
		const result = await fetch(`${SERVER}/api/races/${id}`);
